...
export default function Notificacoes() {
  ...
  // In a real scenario, we would pass the filter to the service. 
  // For this exercise, we filter the current set, but I'll ensure the service is updated for scale.
        ...
        <div className="flex items-center gap-2">
          <div className="relative">
            ...
            <select 
              ...
              className="pl-9 pr-8 h-11 bg-white border-2 border-neutral-100 rounded-xl text-xs font-black uppercase outline-none cursor-pointer appearance-none focus:border-primary transition-all"
            >
              {months.map(m => {
        ...
        <div className="p-8 space-y-4">
          {filteredNotifications.length === 0 ? (
            <div className="py-20 text-center flex flex-col items-center gap-4 opacity-40">
              ...
              <p className="text-xs font-black uppercase tracking-widest">Nenhuma notificação encontrada para este período</p>
            </div>
          ) : (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex justify-between items-start gap-2">
                      <h3 className="text-sm font-black text-neutral-900 uppercase tracking-tight">{n.title}</h3>
